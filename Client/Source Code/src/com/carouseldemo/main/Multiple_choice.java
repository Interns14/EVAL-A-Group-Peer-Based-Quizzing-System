	    ...
	    pd1.show();
		 ...
		 byte[] bytes = Utilities.serialize(p);
			...
			while( true )
			{
				...
				System.out.println("Current seq no : "+currentSeqNo+" got "+ackPack.seq_no+" ack is "+ackPack.ack+" ackpack is "+ackPack.type+" = "+PacketTypes.QUESTION_SEND);
				
				if( ackPack.seq_no != currentSeqNo )
				{
					continue;
				}
