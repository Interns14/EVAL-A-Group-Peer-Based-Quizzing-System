...
public class Essentials 
{
    ...
    static
    {
        try 
        {
            ...
            databaseConnection = (Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/QuizFinalDB","root","reddy123");
        ...
        objHomePage=null;
        objConfigureStudent=null;
        objModifyStudent=null;
    ...
    public static void imp(String l,String c)
    {
        ...
        messages=ResourceBundle.getBundle("DatabaseGUI.MessagesBundle",currentLocale);
        if(messages==null)
        {
        ...
        //  fontURL="file:///users/extusr/animesh14/NetBeansProjects/K010.ttf";
    }
}
